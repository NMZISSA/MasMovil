...
export default forwardRef((props, ref) => {
  ...
  async function deletePrincipalNumber(index) {
    console.log('//////////////');   
    console.log(index);    
    var borras = dataEmpresas.splice(index,index == 0 ? 1 : index)
    console.log(borras);
    Alert.alert(
      "¿Estas seguro?",
      "Se eliminara la bodega: " + borras[0].comercio,
      [
        {
          text: "Cancelar",
        ...
        { text: "Si", onPress: () => eliminarbodega(index) }
      ])   
    cerrarModal();
    console.log('//////////////');
  ...
  async function eliminarbodega(index) {
    var borras = dataEmpresas.splice(index,index == 0 ? 1 : index)
    let ndata = [...dataEmpresas];
    // console.log(borras);
    // console.log(ndata); 
    await guardarDatoJSON('DATA_INI', ndata)
    setDataEmpresas(ndata)  
  }
              ...
              >
                <TouchableOpacity onPress={() => selectPrincipalNumber(index)}>
                  ...
                  >
                    ...
                    <TouchableOpacity
                      onPress={() => deletePrincipalNumber(index)}
                      style={{
                        // position: "absolute",                        
                    ...
                    >
                      <Fontisto name="close" size={25} color={"red"} />
                    </TouchableOpacity>
                  </View>
                </TouchableOpacity>
